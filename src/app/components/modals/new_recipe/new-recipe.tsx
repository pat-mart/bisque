        ...
        <Modal buttonBody={buttonBody} title={"Create new recipe"} urlExtension={'new-recipe'}
           buttons={[
            ...
            <div className="flex flex-col">
                    <input className="p-2 w-full text-xl font-semibold bg-gray-100 border-b-gray-400 dark:bg-gray-700 border-b-2 pl-1 rounded-sm" placeholder="Title"/>
                <div className="flex mt-4 justify-start align-middle gap-x-4 mb-4">
                    ...
                    <div className="mt-2">
                        ...
                        <input className="p-2 pl-1 w-[40%] bg-gray-100 dark:bg-gray-700 rounded-sm" placeholder="30" value={cookTime} type="number" max="999"
                    ...
                    <div className="mt-2">
                        ...
                        <input className="p-2 pl-1 w-[40%] bg-gray-100 dark:bg-gray-700 rounded-sm" placeholder="4" value={servings} type="number" max="999"
